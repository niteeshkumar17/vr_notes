...
| GS_ScienceTech_VR_Notes | 06 — Moderator, reactor types and three-stage (ST-07) | 2026-09-13 | 2 | 90.0% | 2026-09-28 | Confident | 2018 | `MST-081` **held** evening (I+II; flash F12). Stage III **≠ fast**. 15-day **28 Sep**. |
...
| GS_Geography_VR_Notes | 03 — Climatology L10 (Ferrel 1856 / planetary winds) | 2026-09-16 | 3 | 70.0% | 2026-09-19 | Somewhat | 2024 | Ferrel 1856 + 7 belts / 4 types **held**. Invert blank (`MST-098`): belts = **combined**; heat-only **inverts 30/60**. Cluster **+3 19 Sep**. |
...
- **Ghost Recall 17 Sep:** **Q1–Q2** = **16 Sep classes** if ingested. Else leftover **ST-07**. Do **not** steal a new class Q1–Q2. **Q8:** `MST-095` / `MST-096` / `MST-097` / `MST-098`. Leftover Art **341** / joint electorate / `MST-019` Zanskar if a slot.
