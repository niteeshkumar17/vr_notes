...
- **Ghost Recall 18 Sep:** If 17 Sep classes ingested, those two as Q1–Q2. Else **HIS-IVC2 +3** + **ST-08 +3**. **Q7 President +7**. Do **not** steal President for Q1. **Q8:** `MST-095` r2 · `MST-099` · `MST-100` · `MST-101` · `MST-102`.
