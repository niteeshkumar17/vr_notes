...
```mermaid
graph TD
  D["Density 2.7 / 5.5 / 13<br/>composition · state · pressure"] --> T["T non-uniform<br/>1°C / 30 m cannot run to centre"]
  T --> OC["Outer core liquid metal<br/>thermal convection major"]
  IC["Inner core solid metal"] --> GD["Geodynamo<br/>heat → magnetic field"]
  OC --> GD
  GD --> MS["Magnetosphere<br/>irregular shield"]
  MS --> OR["Present field geo S → geo N<br/>declination 11.5°"]
  OR --> AU["Overlap at poles → aurora<br/>O2 green / N2 blue"]
  CME["Flare / wind / plasma"] --> AU
  CME --> ST["Magnetic storm<br/>random aurora any latitude"]
  OC --> FT["Inconstant · weaker over Ga<br/>poles shift · reversal 7–8 lakh yr"]
```
