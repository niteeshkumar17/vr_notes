...
```mermaid
graph TD
    A["Insolation"] --> B["Differential heating"]
    B --> C["Temperature and density differences"]
    C --> D["Pressure differences"]
    D --> E["Wind and air circulation"]
    E --> F["Horizontal heat transfer: advection"]
    C --> G["Vertical movement: convection"]
    G --> H["Rising air: expansion and cooling"]
    G --> I["Sinking air: compression and warming"]
    H --> J["Clouds and precipitation"]
    I --> K["Clear and dry conditions"]
    A --> L["Surface albedo"]
    L --> B
```
