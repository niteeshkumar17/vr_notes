...
graph TD
    ...
    E --> E1["Structure: Rock Composition"]
    E --> E2["Process: Endo + Exo"]
    E --> E3["Time: Duration"]

    B --> J["Relief & Slope"]
    J --> J1["Absolute Relief: from Sea Level"]
    J --> J2["Relative Relief: between 2 locations"]
    J --> J3["Base Level = Sea Level"]

    C --> K["Multiple Processes → Unique Evolution"]
    K --> L["No 2 Landforms Identical"]

    H --- M["Continental Drift 1912"]
    H --- N["Sea Floor Spreading 1962"]
    H --- O["Plate Tectonics 1967"]
    O --> P["Validates Continental Drift & Sea Floor Spreading"]
```
