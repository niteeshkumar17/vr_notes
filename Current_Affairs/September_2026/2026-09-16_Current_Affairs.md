...
flowchart TD
  ...
  CHK -->|yes| FREE["No MDR"]
  CHK -->|P2M above ₹2,000 · mid/large| MDR["0.4% MDR · from 15 Oct"]
  MDR --> SHARE["Shared: banks + app providers"]
  MDR --> CAP["₹75,000+ capped at ₹300"]
```
...
<span style="color: #e53e3e;">**Prelims trap:** **26%** is **merchandise exports**, not overall (**25.4%**). Deficit **$9.4 bn** is **August**, not a FY figure. Class **agri trade surplus** (`04_Agriculture_Importance_Trade_and_Commodities.md`) is a **different** lock.</span>
...
<span style="color: #e53e3e;">**Prelims trap:** Clip says **six States** including **Delhi**. River named is **Tons**, not Yamuna. **90/10** is the **1994** split, not a new formula. **₹15,624 crore** ≠ HP’s old **₹800 crore** offer.</span>
