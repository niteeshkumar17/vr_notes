...
```mermaid
graph TD
    A["Supreme Court Directives (Aug 2026)<br/>Bench: CJI Surya Kant, J. Joymalya Bagchi, J. V. Mohana"] --> B["Mandatory Nationwide Survey"]
    A --> C["Absolute Ban on State Blockades"]
    A --> D["Prohibition of Inhumane Deterrents"]

    B --> B1["Centre (MoEFCC) to survey all ancient/traditional corridors"]
    B --> B2["Comprehensive Action Plan within 8 Weeks"]

    C --> C1["Elephant pathways are Trans-Boundary & Inter-State<br/>(e.g., Nepal → WB → Jharkhand; Haryana → UK → HP)"]
    C --> C2["No single State can obstruct natural movement under pretext of crop protection"]

    D --> D1["Strict implementation of 2018 Apex Court Ban"]
    D --> D2["Illegalisation of 'Hula' Parties using Fireballs, Mashaals, Burning Rods & Spikes"]
```
...
```mermaid
graph TD
    A["SHANTI Act 2025<br/>(Sustainable Harnessing & Advancement of Nuclear Energy for Transforming India)"] --> B["Statutory Liability Caps"]
    A --> C["Supplier Exemption"]
    
    B --> B1["Operator Liability Capped at ₹3,000 Crore"]
    B --> B2["Govt Residual Liability Capped at 300M SDR"]
    
    C --> C1["Exempts Foreign/Domestic Component Manufacturers"]
    
    D["Supreme Court Notice (CJI Surya Kant Bench)"] --> E["Core Constitutional Question"]
    
    E --> F["Can a statutory cap override Constitutional Courts<br/>granting compensation for Legal/Constitutional Tort?"]
    E --> G["Absolute Liability Principle (M.C. Mehta 1987)<br/>Inherent & Non-Delegable Duty under Article 21"]
    
    H["Global Disaster Precedents Cited"]
    H --> H1["Chernobyl (1986): $235 Billion – $700 Billion"]
    H --> H2["Fukushima Daiichi (2011): $400 Billion – $445 Billion"]
    H --> H3["Disparity: ₹3,000 Cr (~$360M) vs Catastrophic Risk"]
```
