...
```mermaid
flowchart LR
    A["Gyirong County, Tibet<br/>source of Lhende Khola"] --> B["Lhende Khola<br/>transboundary, high-altitude"]
    B --> C["Nepal side, near China border<br/>ice + rock + permafrost collapse"]
    C --> D["Temporary debris dam"]
    D --> E["Dam-break surge"]
    E --> F["Bhotekoshi"]
    F --> G["Trishuli"]
```
