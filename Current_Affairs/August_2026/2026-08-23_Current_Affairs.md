...
```mermaid
graph TD
    A["Union Ministry of Home Affairs (MHA) Siliguri Meeting<br/>(Chaired by Home Minister Amit Shah)"] --> B["Constitution of High-Level Modalities Committee"]
    A --> C["Historical Institutional Evolution (1980s–2026)"]
    A --> D["Constitutional & Strategic Dimensions"]

    B --> B1["Chairperson: Shri Pankaj Kumar Singh<br/>(Former Deputy NSA & Current Interlocutor)"]
    B --> B2["Mandate: Draft Agreement & Finalise Modalities for 'Permanent Political Solution'"]
    B --> B3["Scope: Gorkha Community Demands in Darjeeling Hills & Adjoining North Bengal"]
    B --> B4["Commitment: Constitutional Solution & Adequate Central Funding"]

    C --> C1["1980s: GNLF Agitation under Subhash Ghisingh"]
    C --> C2["1988: Darjeeling Gorkha Hill Council (DGHC) Accord"]
    C --> C3["2011: Gorkhaland Territorial Administration (GTA) Accord (GJM)"]
    C --> C4["Institutional Failure: Limited Fiscal/Legislative Powers & Bureaucratic Friction"]

    D --> D1["Constitutional Pathways: Art 3 State/UT vs 6th Schedule vs Art 371"]
    D --> D2["Strategic Imperative: Siliguri Corridor ('Chicken's Neck') Vulnerability"]
    D --> D3["Socio-Cultural: ST Status Demand for 11 Gorkha Sub-Tribes"]
    D --> D4["Regional Dynamics: Hill Aspirations vs South Bengal Territorial Integrity"]
```
