...
```mermaid
flowchart LR
    A["Art 81<br/>seats ~ population"] --> B["Art 82<br/>readjust after each Census"]
    B --> C["42nd CAA 1976<br/>freeze on 1971 shares"]
    C --> D["84th CAA 2001<br/>freeze till Census after 2026"]
    D --> E["2026+ Census<br/>freeze lifts — political fight"]
    E --> F1["Path A: enlarge LS to 800+"]
    E --> F2["Path B Quraishi: keep 543<br/>redraw inside States"]
```
