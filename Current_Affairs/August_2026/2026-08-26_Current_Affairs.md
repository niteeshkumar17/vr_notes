...
```mermaid
flowchart TD
    A["First Judges Case (1981)<br/><i>S.P. Gupta vs Union of India</i>"] -->|"Executive Primacy<br/>'Consultation' ≠ Concurrence"| B["Second Judges Case (1993)<br/><i>SC Advocates-on-Record Association</i>"]
    B -->|"Judicial Primacy Established<br/>CJI + 2 Senior Judges Collective Opinion"| C["Third Judges Case (1998)<br/><i>Article 143 Special Reference</i>"]
    C -->|"Expanded to 5-Member Collegium<br/>CJI + 4 Senior-most SC Judges"| D["99th Constitutional Amendment (2014)<br/><i>National Judicial Appointments Commission (NJAC)</i>"]
    D -->|"Fourth Judges Case (2015)<br/>NJAC Struck Down (Violation of Basic Structure)"| E["Collegium System Reinstated<br/>Promise of Revised MoP Unfulfilled"]
```
...
```mermaid
pie title Empirical Judicial Lineage Estimates
    "Judges with Familial Links to Former Judges" : 30
    "First-Generation / Non-Lineage Judges" : 70
```
...
|:---|:---|:---|:---|
| **United Kingdom (UK)** | **Judicial Appointments Commission (JAC)** | • Publicly advertises all vacancies.<br/>• Open applications based on statutory merit.<br/>• Structured, competency-based interviews. | Independent statutory body; excludes political packing while maintaining open merit. |
| **South Africa** | **Judicial Service Commission (JSC)** | • Public nomination process.<br/>• **Publicly televised live interviews** of shortlisted candidates.<br/>• Detailed public scrutiny of integrity and jurisprudence. | Highest constitutional transparency; strengthens democratic legitimacy. |
| **India** | **Supreme Court / HC Collegium** | • **Zero vacancy advertisement**.<br/>• No application process (closed internal nomination).<br/>• No publicly disclosed evaluation matrix.<br/>• Deliberations in camera without recorded reasons. | Complete judicial monopoly; highly insulated from public scrutiny. |
...
> <span style="color: #e53e3e;">**Core Constitutional Doctrine:** *"The judiciary that demands transparency from every institution of governance cannot ask citizens to trust it on faith alone."* Judicial independence and constitutional accountability are complementary values, not adversarial forces.</span>
...
```mermaid
flowchart LR
    R1["1. Advance Vacancy Notification<br/>(Publish anticipated vacancies)"] --> R2["2. Open Application Window<br/>(Invite applications from eligible Bar/Bench)"]
    R2 --> R3["3. Objective Eligibility Matrix<br/>(Disclose measurable criteria & benchmarks)"]
    R3 --> R4["4. Reasoned Recommendations<br/>(Record objective reasons; protect IB/confidential integrity inputs)"]
```
