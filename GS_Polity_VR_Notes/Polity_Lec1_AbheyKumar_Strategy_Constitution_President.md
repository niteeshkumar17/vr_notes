...
```mermaid
graph TD
    A["Constitutionalism"] --> B["Limited Government"]
    B --> C["Magna Carta 1215 AD - UK"]
    C --> D["King John vs Free Men"]
    B --> E["Constitution of India"]
    E --> F["Part V: Union Government"]
    F --> G["Ch.1: Executive"]
    F --> H["Ch.2: Legislature - Parliament"]
    F --> I["Ch.3: Legislative Powers of President - Ordinances"]
    F --> J["Ch.4: Judiciary - Supreme Court"]
    G --> K["Art. 52: President shall exist"]
    G --> L["Art. 53: Executive power vested in President"]
    G --> M["Art. 58: Eligibility for President"]
    L --> N["Aid & Advice of CoM - Art. 74"]
    L --> O["Decisions in name of President"]
    E --> P["Art. 1: Union & Territory"]
    E --> Q["Part III: Fundamental Rights"]
    Q --> R["To control powers of government"]
    A --> R
    M --> S["Citizen + Age ≥ 35 + Eligible for LS + No OoP"]
    S --> T["PYQ: 2012, 2017, 2022"]
    G --> U["S-163 BNSS replaces S-144 CrPC"]
    U --> V["Prohibitory Orders"]
```
