...
```mermaid
flowchart LR
  subgraph CoM["CoM = the government (~218)"]
    INC[INC + UPA ministers]
  end
  OUT["Outside: SP / BSP / Left"] -->|vote, no ministry| INC
  INC -->|must cross 273 then / 272 now| FLOOR[Floor majority]
```
