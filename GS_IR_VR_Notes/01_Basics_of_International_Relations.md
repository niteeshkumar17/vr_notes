...
<p style="text-align:center;"><em><strong>Figure:</strong> Sovereignty + territory + population + government. Type of government does not matter for the definition.</em></p>
...
<p style="text-align:center;"><em><strong>Figure:</strong> Inside a state, someone can pick up the phone to the police. Between states, nobody comes. Self-help.</em></p>
...
<span style="color: #e53e3e;">**Prelims trap:** Geopolitics is not a synonym for “maps for fun.” **Siliguri / Chicken’s Neck**, **Hormuz**, **Aksai Chin**, **Indus upstream** are the IR facts. **Pax Silica** is a **minerals** counter to China, not a peace slogan.</span>
...
<p style="text-align:center;"><em><strong>Figure:</strong> Internal = grow stronger at home. External = borrow strength through friends. States often do both.</em></p>
...
<span style="color: #e53e3e;">**Prelims trap:** League failed **before** WWII, not because of WWII’s start date alone — **US absence + European BOP habits**. UN (1945) is the **second** try, not the first world government. **P5 veto** is why “UN will save us” is not a security policy.</span>
...
```mermaid
flowchart TD
    A["Anarchy + finite power"] --> B["Struggle for power"]
    B --> C["Conflicts"]
    C --> D["Unresolved → war"]
    D --> E["Realism: Balance of Power"]
    D --> F["Idealism: cooperate"]
    E --> G["Internal / arms race"]
    E --> H["External / alliances"]
    F --> I["Multilateralism + UN 193"]
    F --> J["Treaties: sign then ratify"]
    F --> K["Collective security: League then UN"]
```
