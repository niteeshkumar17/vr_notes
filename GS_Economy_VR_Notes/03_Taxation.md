...
**Seven items still under Value Added Tax (VAT)** (same list as Lecture 01 / file 02): **five petroleum products** (crude, aviation turbine fuel, natural gas, petrol, diesel) **+ alcohol + electricity**. Petrol bill: price + VAT + cess. Delhi electricity bill: charges + VAT + electricity / pension surcharge. Mobile / AC / notebook: price + GST only — that is why a student who only checked GST invoices thought cess/surcharge never sit on indirect tax.
